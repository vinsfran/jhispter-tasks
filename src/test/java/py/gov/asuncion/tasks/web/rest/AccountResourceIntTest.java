package py.gov.asuncion.tasks.web.rest;

import py.gov.asuncion.tasks.config.Constants;
import py.gov.asuncion.tasks.TasksApp;
import py.gov.asuncion.tasks.domain.Authority;
import py.gov.asuncion.tasks.domain.User;
import py.gov.asuncion.tasks.repository.AuthorityRepository;
import py.gov.asuncion.tasks.repository.UserRepository;
import py.gov.asuncion.tasks.security.AuthoritiesConstants;
import py.gov.asuncion.tasks.service.MailService;
import py.gov.asuncion.tasks.service.dto.UserDTO;
import py.gov.asuncion.tasks.service.dto.PasswordChangeDTO;
import py.gov.asuncion.tasks.web.rest.errors.ExceptionTranslator;
import py.gov.asuncion.tasks.web.rest.vm.KeyAndPasswordVM;
import py.gov.asuncion.tasks.web.rest.vm.ManagedUserVM;
import py.gov.asuncion.tasks.service.UserService;
