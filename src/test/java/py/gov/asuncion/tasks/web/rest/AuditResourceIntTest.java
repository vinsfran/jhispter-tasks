...
import py.gov.asuncion.tasks.config.audit.AuditEventConverter;
import py.gov.asuncion.tasks.domain.PersistentAuditEvent;
import py.gov.asuncion.tasks.repository.PersistenceAuditEventRepository;
import py.gov.asuncion.tasks.service.AuditEventService;
